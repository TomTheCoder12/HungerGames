...
while rmgdone == 0:
    try:
        ...
        print((x*y)-(p1+p2+p3+p4),"empty spaces")
        ...
        def randgenlist(place,char):
            ...
            #string = ""
            #indbiomes = string.join(indbiomes)
            #indbiomes = list(indbiomes)
            #print(indbiomes)
            return indbiomes
        ...
        terrain = temp_2
        print("Terrain generated=",terrain)
        t = matrix((len(terrain)),(len(terrain[0])),custom=terrain)
        rmgdone = 1
    except:
        print("Invalid generation")

names = ["Fred","Frodo","Sir Tom Higgithenobotham","Tom Arto","Jake Sell","Dungham MacFred","Donaldus Troomp","Tom Dickenharry","A random guy"]
